...
|                       Invert                        |                      Zoom-Out                      |                     Gaussian Blur                     |                         Saturate                          |                        Pointillism                         |
| :----------------------------------------------------: | :-----------------------------------------------------: | :---------------------------------------------------: | :-------------------------------------------------------: | :--------------------------------------------------------: |
| ![Invert Result](results/kitten-invert.png) |    ![Rotate Result](results/kitten-zo.png)     |     ![Blur Result](path/to/your/blur-output.ppm)      |   ![Saturate Result](path/to/your/saturate-output.ppm)    | ![Pointillism Result](path/to/your/pointillism-output.ppm) |
