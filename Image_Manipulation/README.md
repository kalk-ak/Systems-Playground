...
| :----------------------------------------------------: | :-----------------------------------------------------: | :---------------------------------------------------: | :-------------------------------------------------------: | :--------------------------------------------------------: |
| ![Invert Result](results/kitten-invert.png) |    ![Zoom-Out Result](results/kitten-zo.png)     |     ![Blur Result](results/kitten-blur2.png)      |   ![Binarize Result](results/kitten-bin.png)    | ![Pointillism Result](results/kitten-zo5.png) |
